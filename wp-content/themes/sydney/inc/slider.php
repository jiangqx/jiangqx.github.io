...
function sydney_slider_template() {
    ...
    if ( !function_exists('pll_register_string') ) {
        $slider_title_1     = get_theme_mod('slider_title_1', 'Welcome to jiangqx.com');
        $slider_title_2     = get_theme_mod('slider_title_2', 'It\'s about tech/music/life etc');
        ...
        $slider_subtitle_1  = get_theme_mod('slider_subtitle_1','给同样严肃 有趣 且热爱生活的你');
        $slider_subtitle_2  = get_theme_mod('slider_subtitle_2', '记录 技术 音乐 人生');
